...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0 top-0 z-9999 flex h-screen w-80 flex-col overflow-y-hidden bg-white duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${
      ...
      >
        ...
        <div
          className="flex items-center gap-2 md:absolute bottom-4 left-0 px-6 py-4 w-full"
        >
          ...
          <button
  className="md:mx-6 p-2 ml-44 focus:outline-none"
